  ...
  <body>
    ...
    <div class="kayit">
       <form  action="login.php" method="POST" autocomplete="on">
          <h1>Giriş Yap</h1>
          <p>
               <label for="username" class="uname" data-icon="u" >Adınız:</label>
               <input id="username" name="username" required="required" type="text" placeholder="Adınız"/>
          </p>
          <p>
               <label for="password" class="youpasswd" data-icon="p">Parola:</label>
               <input id="password" name="password" required="required" type="password" placeholder="Parola" />
          </p>
          <!-- <p class="keeplogin">
               <input type="checkbox" name="loginkeeping" id="loginkeeping" value="loginkeeping" />
               <label for="loginkeeping">Beni Hatırla</label>
          </p> -->
